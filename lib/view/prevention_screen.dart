...
class _PreventionScreenState extends State<PreventionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _preventionPageWidgetFull("Prevention of Coronavirus",
  ...
  Widget _preventionPageWidgetFull(String title, String subtitle) {
    return Padding(
  ...
  Widget _preventionPageLeftWidget(
  ...
  Widget _preventionPageRightWidget(
      String title, String subtitle, String svgLink) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(20, 20, 20, 20),
      child: Row(
